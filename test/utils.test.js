...
test('France TV image patterns resolve to absolute URLs at the preferred width', () => {
  ...
  assert.equal(extracted.poster, 'https://api-front.yatta.francetv.fr/big.jpg', 'the widest preference wins');
  assert.equal(extracted.logo, 'https://api-front.yatta.francetv.fr/logo-small.png', 'and falls back when absent');
